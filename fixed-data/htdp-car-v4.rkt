...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname htdp-car-v4) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp")) #f)))
; Exercise 43: move the car according to a sine wave.
...
(define DX 80) ; base delta distance
(define HALF-CAR-WIDTH (/ (image-width CAR) 2))
(define INITIAL-CAR-X (/ WORLD-WIDTH 2))
...
(define (degrees->radians r)
  (* r (/ pi 180)))
(define (car-x cw)
  (+ INITIAL-CAR-X (* DX (sin (degrees->radians cw)))))

(check-expect (car-x 0) INITIAL-CAR-X)

(check-within (degrees->radians 180) pi 0.01)
(check-within (degrees->radians 45) (* 1/4 pi) 0.01)
(check-within (car-x 30) (+ INITIAL-CAR-X (* DX (sin (degrees->radians 30)))) 0.01)
(check-within (car-x 60) (+ INITIAL-CAR-X (* DX (sin (degrees->radians 60)))) 0.01)
